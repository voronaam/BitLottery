 ...
 * must be destroyed using rustsecp256k1_v0_10_0_context_preallocated_destroy (in this
 * module) instead of rustsecp256k1_v0_10_0_context_destroy (in secp256k1.h).
 *
 ...
 *  to rustsecp256k1_v0_10_0_context_preallocated_create.
 *
 *  Returns: the required size of the caller-provided memory block
 *  In:      flags:    which parts of the context to initialize.
 */
SECP256K1_API size_t rustsecp256k1_v0_10_0_context_preallocated_size(
    unsigned int flags
 ...
 *  of size at least rustsecp256k1_v0_10_0_context_preallocated_size(flags) bytes, suitably
 *  aligned to hold an object of any type.
 *
 *  The block of memory is exclusively owned by the created context object during
 *  the lifetime of this context object, which begins with the call to this
 *  function and ends when a call to rustsecp256k1_v0_10_0_context_preallocated_destroy
 ...
 *
 *  See rustsecp256k1_v0_10_0_context_create (in secp256k1.h) for further details.
 *
 */
SECP256K1_API rustsecp256k1_v0_10_0_context *rustsecp256k1_v0_10_0_context_preallocated_create(
    void *prealloc,
    unsigned int flags
